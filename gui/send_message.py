...
# Form implementation generated from reading ui file 'ui/send_message.ui'
#
...
class MyDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        label = QtWidgets.QLabel("This is an alert message.", self)
        layout.addWidget(label)

        button_box = QtWidgets.QDialogButtonBox(QtWidgets.QDialogButtonBox.Ok, self)
